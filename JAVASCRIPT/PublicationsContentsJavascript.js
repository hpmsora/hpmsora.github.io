$(document).ready(function() {
	...
	$.get('/ASSETS/Publications.txt', function(data) {
		...
		for (index = dataList.length - 1; index >= 0 ; index--) {
			...
			paperInfo = "<a style='text-decoration: none' href=" + paperLink + ">" + "<span style='font-weight:bold'> " + paperTitle + "</span></a>" +  "<span style='font-style:italic'>" + ", " +  paperAuthors + "</span>" + 	"<span>" + ", " + paperPublication + "." + "</span>";

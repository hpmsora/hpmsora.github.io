$(document).ready(function() {
	...
	$.get('/ASSETS/Education.txt', function(data) {
		...
		for (index = dataList.length - 1; index >= 0 ; index--) {
			...
			educationInfo = "<a style='text-decoration: none; color: inherit'>" + "<span style='font-weight:bold'> " + educationInstitute + "</span></a>" +  "<span> " + educationDepartment + "</span></br>" + "<span style='font-style:italic'>" + educationDegree + "</span>" + "<span> " + educationMajor + "</span>";
